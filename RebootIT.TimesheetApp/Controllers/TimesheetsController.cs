...
namespace RebootIT.TimesheetApp.Controllers
{
    public class TimesheetsController : Controller
    {
        ...
        {
            ViewData["CompanyName"] = new SelectList(_context.Clients, "Id", "CompanyName");
            ViewData["LocationName"] = new SelectList(_context.Locations, "Id", "Name");
        ...
        public async Task<IActionResult> Create([Bind("Id,MinutesWorked,StaffId,ClientId,LocationId")] Timesheet timesheet)
        {
            ...
            ViewData["CompanyName"] = new SelectList(_context.Clients, "Id", "CompanyName", timesheet.Client);
            ViewData["LocationName"] = new SelectList(_context.Locations, "Id", "Name", timesheet.Location);
